...
export class RankingsService {
  private readonly teamRankings: TeamRanking[] = [
    {
      rank: 1,
      teamId: 'team-001',
      teamName: 'Pawn Stars',
  ...
  private readonly playerRankings: PlayerRanking[] = [
    // Classical
  ...
  private readonly eloHistories: PlayerEloHistory[] = [
    {
      playerId: '1',
      playerName: 'Magnus Carlsen',
      color: '#f59e0b',
      dataPoints: [
        { date: '2024-01', rating: 2820 },
        { date: '2024-02', rating: 2822 },
        { date: '2024-03', rating: 2818 },
        { date: '2024-04', rating: 2825 },
        { date: '2024-05', rating: 2823 },
        { date: '2024-06', rating: 2828 },
        { date: '2024-07', rating: 2826 },
        { date: '2024-08', rating: 2829 },
        { date: '2024-09', rating: 2827 },
        { date: '2024-10', rating: 2830 },
        { date: '2024-11', rating: 2830 },
        { date: '2024-12', rating: 2830 },
      ],
    },
    {
      playerId: '3',
      ...
      color: '#3b82f6',
      dataPoints: [
        { date: '2024-01', rating: 2804 },
        { date: '2024-02', rating: 2806 },
        { date: '2024-03', rating: 2809 },
        { date: '2024-04', rating: 2808 },
        { date: '2024-05', rating: 2812 },
        { date: '2024-06', rating: 2810 },
        { date: '2024-07', rating: 2815 },
        { date: '2024-08', rating: 2818 },
        { date: '2024-09', rating: 2816 },
        { date: '2024-10', rating: 2820 },
        { date: '2024-11', rating: 2819 },
        { date: '2024-12', rating: 2820 },
      ],
    },
    {
      playerId: '12',
      ...
      color: '#22c55e',
      dataPoints: [
        { date: '2024-01', rating: 2795 },
        { date: '2024-02', rating: 2798 },
        { date: '2024-03', rating: 2796 },
        { date: '2024-04', rating: 2800 },
        { date: '2024-05', rating: 2798 },
        { date: '2024-06', rating: 2794 },
        { date: '2024-07', rating: 2796 },
        { date: '2024-08', rating: 2793 },
        { date: '2024-09', rating: 2791 },
        { date: '2024-10', rating: 2793 },
        { date: '2024-11', rating: 2793 },
        { date: '2024-12', rating: 2793 },
      ],
    },
    {
      playerId: '5',
      ...
      color: '#8b5cf6',
      dataPoints: [
        { date: '2024-01', rating: 2786 },
        { date: '2024-02', rating: 2790 },
        { date: '2024-03', rating: 2793 },
        { date: '2024-04', rating: 2791 },
        { date: '2024-05', rating: 2793 },
        { date: '2024-06', rating: 2795 },
        { date: '2024-07', rating: 2793 },
        { date: '2024-08', rating: 2790 },
        { date: '2024-09', rating: 2793 },
        { date: '2024-10', rating: 2793 },
        { date: '2024-11', rating: 2793 },
        { date: '2024-12', rating: 2793 },
      ],
  ...
  findTeamRankings(): TeamRanking[] {
    return [...this.teamRankings].sort((a, b) => a.rank - b.rank)
  }

  findPlayerRankings(modality?: string): PlayerRanking[] {
    const mod = (modality as RatingModality) || 'classical'
    return this.playerRankings
      .filter((p) => p.modality === mod)
      .sort((a, b) => a.rank - b.rank)
  }

  findPlayerEloHistory(playerId: string): PlayerEloHistory | null {
    return this.eloHistories.find((h) => h.playerId === playerId) ?? null
  }

  findEloHistories(): PlayerEloHistory[] {
